...
try {
    ...
    Write-Host "Workspace gerado: $path"
    Write-Host 'Abra esse arquivo no VS Code (File > Open Workspace from File).'
    exit 0
} catch {
    Write-Host ("ERRO ao gerar workspace: " + $_.Exception.Message) -ForegroundColor Red
